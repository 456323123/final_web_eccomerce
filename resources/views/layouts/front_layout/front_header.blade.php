...
<div id="header">
	<div class="container">
		...
		<!-- Navbar ================================================== -->
		<section id="navbar" class="div-mobile">
		  <div class="navbar">
		    <div class="navbar-inner">
		      <div class="container">
		        ...
		        <a class="brand" href="#">Advance Ecommerce project</a>
		        <div class="nav-collapse" id="topsidebar">
		          <ul class=" nav  ">
		            ...
		            <li class="dropdown topmenu"  >
		              <a href="#"  >{{ $section['name'] }} <b class="caret"  ></b></a>
		              <ul class="dropdown-menu  ">
                    @foreach($section['categories'] as $category)
		              	<li class="divider"></li>
		                <li class="nav-header"><a href="{{url('/'.$category['category_url'])  }}">{{ $category['category_name'] }}</a></li>
        ...
        <section id="navbar" class="div-desktop">
		  <div class="navbar">
		    <div class="navbar-inner">
		      <div class="container">
		        <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
